...
";
        ...
        {
            NamedPipeStream = new NamedPipeServerStream("Remotely_Chat" + requesterID, PipeDirection.InOut, 10,
            ...
            Console.WriteLine();
            Console.WriteLine("ChatType your responses below and hit Enter to send.");
        ...
        private void WriteOrgnanizationName(string organizationName)
        {
            ...
            Console.Write("     ");
            for (var i = 0; i < organizationName.Length + 10; i++) Console.Write("/");
            Console.WriteLine();


            Console.Write("    ///");
            for (var i = 0; i < organizationName.Length + 4; i++) Console.Write(" ");
            Console.Write("///");
            Console.WriteLine();
